...
REM
REM Generated by Vivado on Wed Mar 11 17:46:45 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj latch_comparation_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj latch_comparation_tb_vlog.prj -log xvlog.log
