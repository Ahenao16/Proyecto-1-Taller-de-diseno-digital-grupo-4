...
REM
REM Generated by Vivado on Sun Mar 01 20:30:51 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj BCD_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj BCD_tb_vlog.prj -log xvlog.log
