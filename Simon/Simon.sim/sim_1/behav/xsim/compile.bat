...
REM
REM Generated by Vivado on Sun Mar 01 02:01:54 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj frec_divider_param_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj frec_divider_param_tb_vlog.prj -log xvlog.log
