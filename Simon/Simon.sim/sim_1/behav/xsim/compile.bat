...
REM
REM Generated by Vivado on Tue Mar 03 16:12:21 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj button_processing_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj button_processing_tb_vlog.prj -log xvlog.log
