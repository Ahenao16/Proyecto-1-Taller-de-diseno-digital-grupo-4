...
REM
REM Generated by Vivado on Sat Feb 28 18:19:36 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj Sumador_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Sumador_tb_vlog.prj -log xvlog.log
