...
REM
REM Generated by Vivado on Sat Feb 28 12:28:12 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj comparador_param_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj comparador_param_tb_vlog.prj -log xvlog.log
