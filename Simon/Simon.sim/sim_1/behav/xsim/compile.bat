...
REM
REM Generated by Vivado on Sun Mar 01 12:19:18 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj LFSR_16bit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj LFSR_16bit_tb_vlog.prj -log xvlog.log
