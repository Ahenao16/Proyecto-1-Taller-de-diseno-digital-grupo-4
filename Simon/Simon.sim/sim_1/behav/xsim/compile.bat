...
REM
REM Generated by Vivado on Sat Feb 28 21:02:59 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj UpCounter_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj UpCounter_tb_vlog.prj -log xvlog.log
